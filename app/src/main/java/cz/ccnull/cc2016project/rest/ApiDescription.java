...
public interface ApiDescription {
    ...
    Call<Payment> createPayment(@Field("token") String token, @Field("amount") int amount);

    @FormUrlEncoded
    @POST(Config.URL_PAYMENT_HEARD)
    Call<Payment> paymentHeard(@Field("token") String token, @Field("paymentCode") String code);
